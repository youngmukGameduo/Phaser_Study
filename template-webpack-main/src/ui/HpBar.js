...
export default class HpBar extends Phaser.GameObjects.Graphics
{
    ...
    draw()
    {
        ...
        this.fillRect(this.m_x + this.BORDER,this.m_y + this.BORDER,this.WIDTH - 2 * this.BORDER,this.HEIGHT - 2 * this.BORDER);
        ...
        let d = Math.floor((this.WIDTH - 2 * this.BORDER) * (this.m_currentHp / this.m_maxHp));
